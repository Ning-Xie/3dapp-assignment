...
$(document).ready(function(){
	 ...
	 $.getJSON('./model/data.json', function(jsonObj) {
		...
		//Get the zero main text data
		$('#x3dModelTitle_zero').html('<h2>' + jsonObj.pageTextData[5].x3dModelTitle + '<h2>');
		$('#x3dCreationMethod_zero').html('<p>' + jsonObj.pageTextData[5].x3dCreationMethod + '<p>');
		...
		//Get the diet main text data
		$('#x3dModelTitle_diet').html('<h2>' + jsonObj.pageTextData[6].x3dModelTitle + '<h2>');
		$('#x3dCreationMethod_diet').html('<p>' + jsonObj.pageTextData[6].x3dCreationMethod + '<p>');
